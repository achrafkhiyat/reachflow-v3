...
const pillars = [
  {
    ...
    tag: "فيديو",
    description:
      "إنتاج بجودة سينمائية يضعك كالمرجع الأول في مدينتك.",
  },
  {
    icon: (
      <svg
    ...
    tag: "ويب",
    description:
      "صفحة فلترة ترفض العملاء غير المؤهلين تلقائيًا.",
  },
  {
    icon: (
      <svg
    ...
    tag: "إعلانات",
    description:
      "استقطاب أولياء أمور بقدرة مالية وطلاب جادّين (لا طلاب بدون ميزانية).",
  },
];

export default function MechanismAr() {
  return (
    <section className="relative overflow-hidden" style={{ paddingLeft: "32px", paddingRight: "32px", paddingTop: "55px", paddingBottom: "55px" }}>
      ...
      >
        ...
        >
          محرّك الفلترة{" "}
          <br />
          في <ShimmerWord>3 ركائز</ShimmerWord>
        </h2>
      </motion.div>
      ...
      <div className="relative" style={{ maxWidth: "1024px", marginLeft: "auto", marginRight: "auto" }}>
        ...
        <div className="hidden md:block absolute top-1/2 left-[16%] right-[16%] h-[2px] -translate-y-1/2">
          ...
          {/* Traveling data packet — RTL direction */}
          <motion.div
