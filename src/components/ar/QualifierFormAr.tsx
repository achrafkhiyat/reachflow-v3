...
const choiceSteps = [
  {
    headline: "ما هو متوسط عدد التسجيلات الشهرية لديكم؟",
    options: [
      "أقل من 5",
      "بين 5 و 15",
      "بين 15 و 25",
  ...
  {
    headline: "كم عدد العملاء المؤهلين الذين ترغبون في استقطابهم شهريًا؟",
    options: [
      "بين 20 و 40 عميلًا",
      "بين 30 و 50 عميلًا",
      "بين 50 و 100 عميل",
  ...
  {
    headline: "ما الميزانية الشهرية التي يمكنكم تخصيصها لضمان هذه النتائج (إعلانات + أتعاب الوكالة)؟",
    options: [
      "أقل من 7,000 درهم",
      "بين 7,000 و 15,000 درهم",
      "بين 15,000 و 30,000 درهم",
      "أكثر من 30,000 درهم",
    ],
  },
  {
    headline: "أين يقف مكتبكم اليوم؟",
    options: [
      "مكتب راسخ (تدفق منتظم للطلاب)",
      "مكتب نشط لكن بتدفق غير منتظم",
      "في مرحلة الانطلاق / لا عملاء منتظمون بعد",
    ],
  },
  {
    headline: "هل أنتم صاحب القرار الوحيد لهذا النوع من الاستثمار؟",
    options: [
      "نعم، أنا من يتخذ القرار بمفرده",
      "لا، يجب أن أتشاور مع شريك(ة)",
    ],
  },
  {
    headline: "هل أنتم مستعدون للمضي قدمًا والاستثمار في نموّكم إذا كان نظامنا يتوافق مع ما تبحثون عنه؟",
    options: [
      "نعم — إذا كان منطقيًا، فأنا مستعد للمضي قدمًا الآن.",
      "لا — أنا فقط أستعلم ولا أرغب في الاستثمار حاليًا.",
    ],
  },
];

const inputSteps = [
  { key: "name" as const, headline: "ما هو اسمكم الكامل؟", label: "الاسم الكامل", type: "text", placeholder: "اسمكم الكامل" },
  { key: "bureau" as const, headline: "ما هو اسم مكتبكم؟", label: "اسم مكتب التوجيه", type: "text", placeholder: "اسم مكتبكم" },
  { key: "phone" as const, headline: "رقم هاتفكم؟", label: "رقم الهاتف", type: "tel", placeholder: "06 XX XX XX XX" },
];

const totalSteps = choiceSteps.length + inputSteps.length;

export default function QualifierFormAr() {
      ...
      <div style={{ maxWidth: "672px", marginLeft: "auto", marginRight: "auto" }}>
        ...
        >
          ...
          <div className="w-full h-1" style={{ backgroundColor: "rgba(255,255,255,0.05)" }}>
            <motion.div
              className="h-full"
              style={{ backgroundColor: "#F97316", marginLeft: "auto" }}
                    ...
                    {choiceSteps[currentStep].options.map((option) => {
                      ...
                      return (
                        <button
                          ...
                          className="w-full text-right rounded-xl transition-all duration-200 cursor-pointer"
                          style={{
                            padding: "16px 20px",
