...
export default function ThankYouAr() {
  useEffect(() => {
    if (window.fbq) {
  ...
  return (
    <main className="relative min-h-screen bg-void overflow-x-hidden flex flex-col">
      ...
      <div className="relative z-10 flex-1 flex flex-col items-center justify-center px-8 py-20 text-center">
        ...
        >
          تمّ{" "}
          <span className="shimmer-text">تأكيد المكالمة</span>
        </motion.h1>
        ...
        >
          مكالمتك الاستراتيجية محجوزة.
          <br />
          تحقّق من بريدك الإلكتروني لمعرفة <span style={{ color: "#10b981", fontWeight: 700 }}>تفاصيل التأكيد</span>.
        </motion.p>
